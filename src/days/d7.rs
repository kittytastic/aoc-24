...
fn part2_step(val: u64, target: u64, remaining: &[u64])->bool{
    ...
    let using_concat =  part2_step(concat_base_10(next_val, val), target, &remaining[1..]);
...
mod tests {
    ...
    #[test]
    fn test_concat() {
        assert_eq!(concat_base_10(3, 4), 43);
        assert_eq!(concat_base_10(10, 19), 1910);
        assert_eq!(concat_base_10(6, 15), 156);
    }
}